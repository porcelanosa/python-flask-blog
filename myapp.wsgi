...
activate_this = '/var/www/porcelanosa/data/www/blog.71b.ru/newenv/bin/activate_this.py'
...
sys.path.insert(0, '/var/www/porcelanosa/data/www/blog.71b.ru/dream_team_app')
sys.path.insert(0, '/var/www/porcelanosa/data/www/blog.71b.ru/dream_team_app/run.py')
